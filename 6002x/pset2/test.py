...
class Tile(object):
    ...
    def Clean(self):
        self.clean = True
    def __str__(self):
        return "Tile: x: " + str(self.x) + " - " + str(self.x + 1) + " | y: " + str(self.y) + " - " + str(self.y + 1) + '.'
...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        if self.Tiles[int(pos.getX())][int(pos.getY())].getClean() == False:
            self.Tiles[int(pos.getX())][int(pos.getY())].Clean()
            self.cleanTiles.append(self.Tiles[int(pos.getX())][int(pos.getY())])
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        return self.Tiles[m][n].getClean()
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    """
    mean = 0
    minCov = min_coverage * width * height
    for i in range(num_trials):
        ...
        counter = 0
        while room.getNumCleanedTiles() < minCov:
            for robot in robots:
                robot.updatePositionAndClean()
            counter += 1
        mean += counter / num_trials
    return mean
